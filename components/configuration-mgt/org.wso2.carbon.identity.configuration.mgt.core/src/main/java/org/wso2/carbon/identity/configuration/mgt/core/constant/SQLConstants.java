...
public class SQLConstants {
    ...
    public static final String INSERT_RESOURCE_TYPE_SQL = "INSERT INTO IDN_CONFIG_TYPE (ID, NAME, DESCRIPTION, " +
            "TENANT_ID) VALUES (?, ?, ?, ?)";
    public static final String GET_CREATED_TIME_COLUMN_MYSQL = "SELECT CREATED_TIME FROM IDN_CONFIG_RESOURCE";
    ...
    public static final String INSERT_RESOURCE_SQL_WITHOUT_CREATED_TIME = "INSERT INTO\n" +
            ...
            "  )" +
            "VALUES(?, ?, ?, ?, ?, ?, ?)";
    public static final String GET_RESOURCE_METADATA_BY_ID_SQL = "SELECT ID, CREATED_TIME, LAST_MODIFIED FROM " +
            "IDN_CONFIG_RESOURCE WHERE ID = ?";
    public static final String GET_RESOURCE_METADATA_BY_ID_SQL_WITHOUT_CREATED_TIME = "SELECT ID, LAST_MODIFIED FROM " +
            "IDN_CONFIG_RESOURCE WHERE ID = ?";
